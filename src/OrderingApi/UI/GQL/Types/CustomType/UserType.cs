...
//               //return await postRepository.GetPostsByUserIdAsync(context.Source.Id);
//
//               // avoid N+1 query problems
//
//               // Get or add a batch loader with the key "GetPostsById"
//               // The loader will call GetPostsByIdAsync for each batch of keys
//               var loader = dataLoaderContextAccessor.Context.GetOrAddCollectionBatchLoader<string, Post>("GetPostsById", postRepository.GetPostsByUserIdsAsync);
//
